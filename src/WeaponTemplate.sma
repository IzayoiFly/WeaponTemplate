...
public Event_FreezeEnd() g_iRoundStart = true
...
public HAM_UseStationary_Post(iEntity, id, activator, use_type) if (!use_type && is_user_connected(id)) Event_CurWeapon(id)
